...
<b>📋 Вам потребуется доза <code>{2}</code> μg (мкг) чтобы почувствовать те же эффекты, что и ваша последняя доза.</b>
            
<b>💬 Обратите внимание❗️</b> этот калькулятор работает только для триптаминов, таких как ЛСД и волшебные грибы, не используйте этот калькулятор для химических веществ, которые не являются триптаминами.
